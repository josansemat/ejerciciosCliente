...
require_once 'Precipitaciones.php'; // Incluir el archivo de la clase Periferico
...
$consulta = $conexion->query("SELECT id,mes,precipitaciones,anio FROM precipitaciones");
while ($reg = $consulta->fetchObject()) {
  $vec[] = new Precipitaciones($reg->id,$reg->mes,$reg->precipitaciones,$reg->anio);
}
